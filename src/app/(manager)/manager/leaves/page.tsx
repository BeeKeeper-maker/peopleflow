                                            ...
                                            <td className="px-4 py-3">
                                                <div className="flex items-center gap-3">
                                                    <Avatar className="h-8 w-8">
                                                        ...
                                                        <AvatarFallback className="bg-linear-to-br from-orange-500 to-red-600 text-foreground text-xs">{leave.employeeName.split(" ").map((part) => part[0]).join("").slice(0, 2)}</AvatarFallback>
                                                    </Avatar>
