        ...
        <div className="space-y-6">
            ...
            <div className="flex items-start justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold tracking-tight bg-linear-to-r from-amber-400 via-orange-400 to-rose-400 bg-clip-text text-transparent">
                            {t('title')}
                        </h1>
                        ...
                        <div className="flex-1 overflow-hidden flex flex-col gap-4">
                            ...
                            <div className="grid grid-cols-3 gap-3">
                                <div className="rounded-xl bg-linear-to-br from-emerald-500/15 to-emerald-500/5 border border-emerald-500/10 p-4 text-center">
                                    ...
                                    <p className="text-2xl font-bold text-emerald-400">{generateResult.totalEligible}</p>
                                ...
                                <div className="rounded-xl bg-linear-to-br from-red-500/10 to-red-500/5 border border-red-500/10 p-4 text-center">
                                    ...
                                    <p className="text-2xl font-bold text-red-400">{generateResult.totalIneligible}</p>
                                ...
                                <div className="rounded-xl bg-linear-to-br from-blue-500/10 to-blue-500/5 border border-blue-500/10 p-4 text-center">
                                    ...
                                    <p className="text-2xl font-bold text-blue-400" suppressHydrationWarning>৳{generateResult.totalAmount.toLocaleString()}</p>
